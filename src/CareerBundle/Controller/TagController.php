...
class TagController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $tags = $em->getRepository('CareerBundle:Tag')->findAll();
    ...
    {
        $tag = new Tag();
        $form = $this->createForm('CareerBundle\Form\TagType', $tag);
    ...
    {
        $deleteForm = $this->createDeleteForm($tag);
        $editForm = $this->createForm('CareerBundle\Form\TagType', $tag);
