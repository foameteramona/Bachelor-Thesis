...
class EventTypeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $eventTypes = $em->getRepository('CareerBundle:EventType')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('CareerBundle\Form\EventTypeType', $eventType);
    ...
    {
        $deleteForm = $this->createDeleteForm($eventType);
        $editForm = $this->createForm('CareerBundle\Form\EventTypeType', $eventType);
